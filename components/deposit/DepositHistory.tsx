...
const DepositHistory = () => {
  ...
  return (
    <div className="w-[90%] mx-auto text-white my-10">
      <h4 className="underline text-base md:text-xl font-body font-semibold">
        Deposit History
      </h4>
          ...
          transactions.map((transaction: any) => (
            <>
              <div
                ...
                className="flex items-center justify-between cursor-pointer hover:bg-stone-900/40 p-3 ease transition-all rounded-xl"
              >
                <div>
...
const DepositDetailsModal = ({ id, show, close }: any | unknown) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="md:w-[50%] w-[80%] mx-auto md:mt-14 bg-stone-900 p-4 font-body">
